...
public class ParallelNiceTreeDecompositionResultHandlerFactory implements IResultHandlerFactory {
    @Override
    public IResultHandler produce() {
        return inject(new ParallelNiceTreeDecompositionResultHandler());
    }

    private IResultHandler inject(ParallelNiceTreeDecompositionResultHandler resultHandler) {
