package tdk_enum.factories.enumeration.result_handler_factory.tree_decomposition;

import tdk_enum.common.IO.result_handler.IResultHandler;
import tdk_enum.common.IO.result_handler.tree_decomposition.parallel.ParallelTreeDecompositionResultHandler;
...
public class ParallelTreeDecompositionResultHandlerFactory implements IResultHandlerFactory {
    @Override
    public IResultHandler produce() {

        return inject(new ParallelTreeDecompositionResultHandler());
    }

    private IResultHandler inject(ParallelTreeDecompositionResultHandler resultHandler) {
