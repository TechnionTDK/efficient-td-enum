...
public class SingleThreadNiceTreeDecompositionResultHandlerFactory implements IResultHandlerFactory {


    @Override
    public IResultHandler produce() {
        return inject(new SingleThreadNiceTreeDecompositionResultHandler());
    }

    private IResultHandler inject(SingleThreadNiceTreeDecompositionResultHandler resultHandler) {
