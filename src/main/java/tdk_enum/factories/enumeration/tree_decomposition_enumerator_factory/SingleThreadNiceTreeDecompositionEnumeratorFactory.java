...
import tdk_enum.enumerators.tree_decomposition.single_thread.NiceTreeDecompositionEnumerator;
...
public class SingleThreadNiceTreeDecompositionEnumeratorFactory implements ITreeDecompositionEnumeratorFactory {
    @Override
    public INiceTreeDecompositionEnumerator produce() {
        return inject(new NiceTreeDecompositionEnumerator());
    }
