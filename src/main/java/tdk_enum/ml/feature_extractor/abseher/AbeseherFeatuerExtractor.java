...
public class AbeseherFeatuerExtractor extends AbstractFeatureExtractor {
    @Override
    public FeatureExtractionResult getFeatures(int tdID, ITreeDecomposition treeDecomposition, IGraph graph) {
    ...
    @Override
    public FeatureExtractionResult getFeatures(int tdID, ITreeDecomposition treeDecomposition, IGraph graph, BenchmarkRun benchmarkRun) {
        FeatureCollection featureCollection = FeatureCollection.getDefaultFeatureCollection();
