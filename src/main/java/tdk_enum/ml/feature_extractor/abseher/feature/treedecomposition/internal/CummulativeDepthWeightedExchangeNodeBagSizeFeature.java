 ...
 */
public class CummulativeDepthWeightedExchangeNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeDepthWeightedExchangeNodeBagSizeFeature() {
        super("CummulativeDepthWeightedExchangeNodeBagSize");
    }
