 ...
 */
public class CummulativeDepthWeightedForgetNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeDepthWeightedForgetNodeBagSizeFeature() {
        super("CummulativeDepthWeightedForgetNodeBagSize");
    }
