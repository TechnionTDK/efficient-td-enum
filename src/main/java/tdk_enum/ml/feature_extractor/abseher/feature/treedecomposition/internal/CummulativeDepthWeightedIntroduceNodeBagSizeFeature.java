 ...
 */
public class CummulativeDepthWeightedIntroduceNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeDepthWeightedIntroduceNodeBagSizeFeature() {
        super("CummulativeDepthWeightedIntroduceNodeBagSize");
    }
