 ...
 */
public class CummulativeDepthWeightedIntroducedVertexNeighborCountFeature extends TreeDecompositionFeature {
    
    public CummulativeDepthWeightedIntroducedVertexNeighborCountFeature() {
        super("CummulativeDepthWeightedIntroducedVertexNeighborCount");
    }
