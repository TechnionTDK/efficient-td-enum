 ...
 */
public class CummulativeDepthWeightedLeafNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeDepthWeightedLeafNodeBagSizeFeature() {
        super("CummulativeDepthWeightedLeafNodeBagSize");
    }
