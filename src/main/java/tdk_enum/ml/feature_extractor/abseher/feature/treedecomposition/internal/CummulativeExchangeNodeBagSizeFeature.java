 ...
 */
public class CummulativeExchangeNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeExchangeNodeBagSizeFeature() {
        super("CummulativeExchangeNodeBagSize");
    }
