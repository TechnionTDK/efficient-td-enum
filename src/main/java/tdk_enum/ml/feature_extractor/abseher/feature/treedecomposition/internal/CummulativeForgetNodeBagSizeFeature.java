 ...
 */
public class CummulativeForgetNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeForgetNodeBagSizeFeature() {
        super("CummulativeForgetNodeBagSize");
    }
