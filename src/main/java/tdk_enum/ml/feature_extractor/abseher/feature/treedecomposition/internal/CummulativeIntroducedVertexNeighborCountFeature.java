 ...
 */
public class CummulativeIntroducedVertexNeighborCountFeature extends TreeDecompositionFeature {
    
    public CummulativeIntroducedVertexNeighborCountFeature() {
        super("CummulativeIntroducedVertexNeighborCount");
    }
