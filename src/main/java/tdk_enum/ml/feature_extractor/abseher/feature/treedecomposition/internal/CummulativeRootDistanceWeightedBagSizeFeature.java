 ...
 */
public class CummulativeRootDistanceWeightedBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeRootDistanceWeightedBagSizeFeature() {
        super("CummulativeRootDistanceWeightedBagSize");
    }
