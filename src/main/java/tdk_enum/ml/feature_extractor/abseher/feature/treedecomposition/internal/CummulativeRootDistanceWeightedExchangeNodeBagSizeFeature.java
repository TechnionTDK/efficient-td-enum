 ...
 */
public class CummulativeRootDistanceWeightedExchangeNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeRootDistanceWeightedExchangeNodeBagSizeFeature() {
        super("CummulativeRootDistanceWeightedExchangeNodeBagSize");
    }
