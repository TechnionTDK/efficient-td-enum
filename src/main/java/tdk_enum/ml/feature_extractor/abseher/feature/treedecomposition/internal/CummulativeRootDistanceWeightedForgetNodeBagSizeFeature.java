 ...
 */
public class CummulativeRootDistanceWeightedForgetNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeRootDistanceWeightedForgetNodeBagSizeFeature() {
        super("CummulativeRootDistanceWeightedForgetNodeBagSize");
    }
