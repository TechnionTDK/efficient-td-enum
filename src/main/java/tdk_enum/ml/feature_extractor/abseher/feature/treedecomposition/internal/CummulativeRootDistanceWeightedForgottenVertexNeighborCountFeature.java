 ...
 */
public class CummulativeRootDistanceWeightedForgottenVertexNeighborCountFeature extends TreeDecompositionFeature {
    
    public CummulativeRootDistanceWeightedForgottenVertexNeighborCountFeature() {
        super("CummulativeRootDistanceWeightedForgottenVertexNeighborCount");
    }
