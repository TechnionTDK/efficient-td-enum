 ...
 */
public class CummulativeRootDistanceWeightedJoinNodeBagSizeFeature extends TreeDecompositionFeature {
    
    public CummulativeRootDistanceWeightedJoinNodeBagSizeFeature() {
        super("CummulativeRootDistanceWeightedJoinNodeBagSize");
    }
