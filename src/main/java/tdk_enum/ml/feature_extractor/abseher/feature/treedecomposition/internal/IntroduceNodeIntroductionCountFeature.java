 ...
 */
public class IntroduceNodeIntroductionCountFeature extends TreeDecompositionFeature {
    
    public IntroduceNodeIntroductionCountFeature() {
        super("IntroduceNodeIntroductionCount");
    }
