 ...
 */
public class IntroducedVertexConnectednessFactorFeature extends TreeDecompositionFeature {
    
    public IntroducedVertexConnectednessFactorFeature() {
        super("IntroducedVertexConnectednessFactor");
    }
    ...
    private double getConnectednessFactor(IGraph instance, DecompositionNode node) {
        double ret = 0.0;
        
        if (instance != null && node != null) {
            if (node.getIntroducedItemList().size() > 0) {
                int count = 0;
