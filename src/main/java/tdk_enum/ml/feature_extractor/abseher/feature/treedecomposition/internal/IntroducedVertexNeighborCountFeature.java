 ...
 */
public class IntroducedVertexNeighborCountFeature extends TreeDecompositionFeature {
    
    public IntroducedVertexNeighborCountFeature() {
        super("IntroducedVertexNeighborCount");
    }
